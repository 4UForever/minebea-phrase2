...
public final class CameraManager {
 ...
 // private static final int MAX_FRAME_HEIGHT = 400;
   ...
   */
  public synchronized void openDriver(SurfaceHolder holder,int viewWidth,int viewHeight , int cameraType) throws IOException {
    Camera theCamera = camera;
    if (theCamera == null) {
      theCamera = new OpenCameraManager().build().open(cameraType);
      if (theCamera == null) {
