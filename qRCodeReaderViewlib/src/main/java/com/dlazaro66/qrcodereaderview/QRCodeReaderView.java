...
public class QRCodeReaderView extends SurfaceView implements SurfaceHolder.Callback, Camera.PreviewCallback {
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        try {
            ...
            mCameraManager.openDriver(holder, this.getWidth(), this.getHeight(), cameraType);
        } catch (IOException e) {
...
//        }
        ...
        mCameraManager.startPreview();
        if (mHolder.getSurface() == null || mCameraManager.getCamera() == null) {
            Log.e(TAG, "Error: preview surface does not exist");
            return;
        }
        ...
        if (display.getRotation() == Surface.ROTATION_270) {
            ...
            if ("LENOVO Lenovo TB3-X70L".equalsIgnoreCase(deviceName)) {
                mCameraManager.getCamera().setDisplayOrientation(270);
            } else {
                mCameraManager.getCamera().setDisplayOrientation(90);
            }
        }
